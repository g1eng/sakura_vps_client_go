...
func Test_sakura_vps_NfsServerAPIService(t *testing.T) {
	...
	t.Run("Test NfsServerAPIService GetNfsServerStorage", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var nfsServerId int32

		resp, httpRes, err := apiClient.NfsServerAPI.GetNfsServerStorage(context.Background(), nfsServerId).Execute()
