...
func (r ApiGetDiscListRequest) Execute() (*GetDiscList200Response, *http.Response, error) {
	return r.ApiService.GetDiscListExecute(r)
}
...
func (a *DiscAPIService) GetDiscListExecute(r ApiGetDiscListRequest) (*GetDiscList200Response, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *GetDiscList200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DiscAPIService.GetDiscList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/discs"
